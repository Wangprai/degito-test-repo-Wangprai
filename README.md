...
ใช้เวลาทั้งหมดประมาณ 2 ชั่วโมง 8 นาทีในการทำ Assignment นี้

## Testing

ผมได้ทดสอบการทำงานของฟีเจอร์และการแก้ไข Bug หลักดังนี้:

- Change Project Status และตรวจสอบการ update บนหน้าเว็บ
- Create Project ด้วยข้อมูลที่ถูกต้องและไม่ถูกต้อง
- ตรวจสอบการแสดง Project ว่าไม่มีข้อมูลซ้ำ
- ตรวจสอบการแสดง Error เมื่อ API ทำงานไม่สำเร็จ
- ค้นหา Project ด้วยชื่อ Client
- ตรวจสอบการค้นหาแบบไม่สนใจ sensitive case